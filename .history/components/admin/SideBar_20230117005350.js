                                       ...
                                       {/*  <li className="w-100">
                                         ...
                                         <li className="w-100">
                                            <Link href={"/admin/siswa-gql/datasiswa"}>
                                                ...
                                                <a className="nav-link px-0"> 
                                                    <span className="d-none d-sm-inline">Data Siswa</span> 
                                                </a>
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href={"/admin/siswa-gql/createsiswa"}>
                                                <a className="nav-link px-0"> <span className="d-none d-sm-inline">Tambah Siswa</span></a>
                                            </Link>
                                        </li>
                                        <li className="w-100">
                                            <Link href={"/admin/buku-gql/databuku"}>           
                                                <a className="nav-link px-0"> 
                                                    <span className="d-none d-sm-inline">Data Buku</span> 
                                                </a>
                                            </Link>
                                        </li>
                                        ...
                                        <li>
                                            <Link href={"/admin/buku-gql/createbuku"}>
                                                <a className="nav-link px-0"> <span className="d-none d-sm-inline">Tambah Buku</span></a>
                                            </Link>
                                        </li>
                                        <li className="w-100">
                                            <Link href={"/admin/petugas-gql/datapetugas"}>           
                                                <a className="nav-link px-0"> 
                                                    <span className="d-none d-sm-inline">Data Petugas</span> 
                                                </a>
                                            </Link>
                                        </li>
                                        ...
                                        <li>
                                            <Link href={"/admin/petugas-gql/createpetugas"}>
                                                <a className="nav-link px-0"> <span className="d-none d-sm-inline">Tambah Petugas</span></a>
                                            </Link>
                                        </li>
...
//jika ingin menggunakan mahasiswa remark dibawah ini
// const SideBar = ({ children }) => {
//     return (
//         <div>
//             <div className="container-fluid">
