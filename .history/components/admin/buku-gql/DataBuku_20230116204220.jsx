    ...
    async function hapusBuku(kdbuku) {
        ...
        try {
            ...
            const response = await axios.delete(
                `http://localhost:1337/api/buku/${kdbuku}`
              );
                    ...
                    <tr key ={idx}>
                            ...
                            <td>
                                <div className="d-flex justify-content-between">
                                    ...
                                    <Link href={
                                       { pathname : '/admin/buku-gql/updatebuku', 
                                         query : {kdbuku : buk.kdbuku, buku : buk.buku, pengarang : buk.pengarang, penerbit : buk.penerbit}
                                       }
                                        }
                                    >
                                        <a>Edit-GraphQL</a>
