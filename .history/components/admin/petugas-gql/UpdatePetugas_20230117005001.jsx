...
const UpdatePetugas = () => {
    ...
    const [_no_telfon, setNo_telfon] = useState('');

    //mengambil data yang dikirim melalui router
    const router = useRouter();
    const {id, kdpetugas, nama, no_telfon} = router.query;
    ...
    useEffect(() => {
        ...
        if (typeof no_telfon == 'string') {
            setNo_telfon(no_telfon)
        }
    },[kdpetugas,nama,no_telfon])
        ...
        <div className="container mt-4">
            <form className="w-50 mx-auto" onSubmit={submitHandler}>
                ...
                <div className="w-75">
                    ...
                    <div className="form-floating">
                        <input className="form-control mb-2" id="no_telfon" type="text" placeholder="No_Telfon" value={_no_telfon} onChange={(e) => setNo_telfon(e.target.value)} />
